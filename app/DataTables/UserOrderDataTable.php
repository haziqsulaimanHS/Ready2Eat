    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                \Log::info($query); // This will log the contents of the $query object to your log file
                $showBtn = "<a href='".route('user.orders.show', $query->id)."' class='btn btn-primary'><i class='far fa-eye'></i></a>";
//                $rvwBtn = "<a href='".route('product-detail', $query->slug)."' class='btn btn-success'><i class='far fa-address-book'></i></a>";
