<header>
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <a class="wsus__header_logo" href="{{url('/')}}">
                        <img src="{{asset($logoSetting->logo)}}" alt="logo" class="img-fluid w-100" style="height: 70px">
                    </a>
                </div>
            </div>

            <!-- Center: Search Bar -->
            <div class="col-xl-5 col-md-6 col-lg-4 d-none d-lg-block mx-auto">
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6 d-flex justify-content-end align-items-center">
                <div class="wsus__call_icon_area d-flex align-items-center">
                    ...
                    <!-- Icons -->
                    @can ('AllUser')
                        <ul class="wsus__icon_area d-flex list-unstyled mb-0">
                            <li class="me-3"><a href="{{route('user.wishlist.index')}}"><i class="fal fa-heart"></i><span id="wishlist_count">
                            @if (auth()->check())
