                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                aria-controls="v-pills-cod" aria-selected="true">COD</button>

                                <button class="nav-link common_btn active" id="v-pills-home-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-fpx" type="button" role="tab"
                                        aria-controls="v-pills-fpx" aria-selected="false">FPX</button>
...
{{--                            @include('frontend.pages.payment-gateway.razorpay')--}}
                            ...
                            @include('frontend.pages.payment-gateway.fpx')
