                                                ...
                                                <div class="row content-row">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 mb-4 mb-lg-0">
                                                        <div class="wsus__pro_det_info">
                                                            ...
                                                            <br>
                                                            <p><span><strong>TOTAL CALORIES : </strong></span>{!! $product->calorie !!} <strong>&nbsp; (kcal)</strong></p>
                                                            <p><span><strong>TOTAL SERVING : </strong></span>{!! $product->serving !!} </p>
                                                            <p><span><strong>WEIGHT : </strong></span>{!! $product->weight !!}  <strong>&nbsp; (g)</strong></p>
                                                            <p><span><strong>PROTEIN : </strong></span>{!! $product->protein !!}  <strong>&nbsp; (g)</strong></p>
                                                            <p><span><strong>CARBS : </strong></span>{!! $product->carbs !!}  <strong>&nbsp; (g)</strong></p>
                                                            <p><span><strong>FAT : </strong></span>{!! $product->fat !!}  <strong>&nbsp; (g)</strong></p>
                                                        </div>
                                                    </div>
                                                    <!-- Right column for Ingredients and Allergens -->
                                                    <div class="col-xl-6 col-lg-6">
                                                        <div>
                                                            <h5>Ingredients : <span>{!! $product->allergens !!}</span></h5>
                                                            <br>
                                                            <h5>Allergens : <span>{!! $product->long_description !!}</span></h5>
