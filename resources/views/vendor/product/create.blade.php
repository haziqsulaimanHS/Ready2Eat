              ...
              <div class="wsus__dash_pro_area">
                <form action="{{route('vendor.products.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="allergens" value="{{old('allergens')}}">
                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="serving" value="{{old('serving')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Weight</label>
                                            ...
                                            <div class="form-group">
                                                <label>Carbs</label>
                                                <input type="text" class="form-control" name="carbs" value="{{old('carbs')}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Fat</label>
                                                <input type="text" class="form-control" name="fat" value="{{old('fat')}}">
                                            </div>
