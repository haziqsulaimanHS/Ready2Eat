              ...
              <div class="wsus__dash_pro_area">
                <form action="{{route('vendor.products.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="allergens" value="{{$product->allergens}}">
                    </div>

                                            <div class="form-group">
                                                <label>Total Calories</label>
                                                <input type="text" class="form-control" name="calorie" value="{{$product->calorie}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Total Serving</label>
                                                <input type="text" class="form-control" name="serving" value="{{$product->serving}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Weight</label>
                                            ...
                                            <div class="form-group">
                                                <label>Protein</label>
                                                <input type="text" class="form-control" name="protein" value="{{$product->protein}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Carbs</label>
                                                <input type="text" class="form-control" name="carbs" value="{{$product->carbs}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Fat</label>
                                                <input type="text" class="form-control" name="fat" value="{{$product->fat}}">
                                            </div>
