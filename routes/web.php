...
Route::group(['middleware' =>['auth', 'verified'], 'prefix' => 'user', 'as' => 'user.'], function(){
    ...
    Route::get('orders/status/{id}', [UserOrderController::class, 'orderStatus'])->name('orders.status');
    ...
    /** FPX routes */
    Route::get('fpx/payment', [PaymentController::class, 'payWithFpx'])->name('fpx.payment');
    /** FPX routes */
    Route::post('maybank/payment', [PaymentController::class, 'payMaybank'])->name('maybank.payment');
